...
You can see the full change in [routes/api/profile.js](https://github.com/adityaa127/devconnect_2.0/blob/4be414c6a54994c18397dba9c927ad67b878508b/routes/api/profile.js#L324)

## uuid no longer has a default export

The npm package [uuid](https://www.npmjs.com/package/uuid) no longer has a default export, so in our [client/src/actions/alert.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/actions/alert.js) we need to change the import and use of this package.
...
You can see the use here in [routes/api/profile.js](https://github.com/adityaa127/devconnect_2.0/blob/31e5318592b886add58923c751dba73274c711de/routes/api/profile.js#L71)
...
You can see the code use here in [routes/api/users.js](https://github.com/adityaa127/devconnect_2.0/blob/master/routes/api/users.js#L44)
...
The subscription can be seen in [client/src/store.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/store.js)

We also need to change our [client/src/utils/setAuthToken.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/utils/setAuthToken.js) so it now handles both the setting of the token in local storage and in axios headers.
`setauthToken.js` in turn depends on [client/src/utils/api.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/utils/api.js) where we create an instance of axios. So you will also need to grab that file.

With those two changes in place we can remove all setting of local storage from [client/src/reducers/auth.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/reducers/auth.js). And remove setting of the token in axios headers from [client/src/actions/auth.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/actions/auth.js). This helps keep our code predictable, manageable and ultimately bug free.

## Component reuse ♻️

The EditProfile and CreateProfile have been reduced to one component [ProfileForm.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/components/profile-forms/ProfileForm.js)  
...
**You can see the implementation of the interceptor and axios instance in [utils/api.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/utils/api.js)**

Creating an instance of axios also cleans up our action creators in [actions/auth.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/actions/auth.js), [actions/profile.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/actions/profile.js) and [actions/post.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/actions/post.js)

Note that implementing this change also requires that you use the updated code in [utils/setAuthToken.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/utils/setAuthToken.js)
Which also in turn depends on [utils/api.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/utils/api.js)
I would also recommending updating to use a [ redux subscription ](https://github.com/adityaa127/devconnect_2.0#redux-subscription-to-manage-local-storage-) to mange setting of the auth token in headers and local storage.
...
Some of you in the course have been having problems installing both packages and meeting peer dependencies.\
 ...
 First create a [ utils/formatDate.js ](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/utils/formatDate.js) file, with the following code...
...
Then in our [Education.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/components/dashboard/Education.js) component, import the new function...
...
- [Education.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/components/dashboard/Education.js)
- [Experience.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/components/dashboard/Experience.js)
- [CommentItem.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/components/post/CommentItem.js)
- [PostItem.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/components/posts/PostItem.js)
- [ProfileEducation.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/components/profile/ProfileEducation.js)
- [ProfileExperience.js](https://github.com/adityaa127/devconnect_2.0/blob/master/client/src/components/profile/ProfileExperience.js)
...
their [ own styling ](https://github.com/adityaa127/devconnect_2.0/blob/c5b1fc48ccfecf30b6ed85f228a337f82d93e3f9/client/src/App.css#L579) so they are `position: fixed;` and we get no content shift,
...
Aditya (adityaa127)
[Aditya (adityaa127)](http://www.traversymedia.com)
